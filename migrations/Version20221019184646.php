 ...
 */
final class Version20221019184646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, author_id INT DEFAULT NULL, owner_id INT DEFAULT NULL, book_name VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, publisher VARCHAR(255) NOT NULL, INDEX IDX_CBE5A33112469DE2 (category_id), INDEX IDX_CBE5A331F675F31B (author_id), INDEX IDX_CBE5A3317E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
